...
<div class="main-div">
    <div class="main-top">
        ...
        <div class="insert-btn-div">
            <button class="insert-btn" v-if="!this.$store.state.setting.clickState" 
                    @click="changeClickState()">수정</button>
            <button class="insert-btn" v-if="this.$store.state.setting.clickState" 
                    @click="changeClickState()">닫기</button>
        </div>
    </div>
